...
<div class="content">
	...
	<div class="simplebox grid740">
        ...
        <table class="tablesorter list"> 
            ...
            <tbody> 
			<?php
			$query = $mth->query("SELECT * FROM ".module_table." ORDER BY id DESC");
			...
			?>
                <tr id="data<?=$list["id"]?>"> 
                    ...
                    <td>
						<a class="tips" title="Yöneticiyi Düzenle" href="<?=module_link?>/edit&id=<?=$list["id"]?>">
							<img src="img/icons/sidemenu/file_edit.png" alt="" />
						</a>
						<a class="tips" title="Yöneticiyi Sil" href="<?=module_link?>/list&deleteID=<?=$list["id"]?>">
