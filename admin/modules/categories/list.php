	...
	<div class="simplebox grid740">
		<div style="height: 32px;">
			...
			<div class="process float-right">
				...
				if($_GET["deleteID"]){
					$mth->delete(module_table, "WHERE id='".$_GET["deleteID"]."'");
				...
				if($_POST["delete"]){
					...
					foreach($delete as $deleted){
						$delete = $mth->delete(module_table,"WHERE id='".$deleted."'");
						if($delete){
        ...
        <table class="tablesorter list"> 
            ...
            <tbody> 
			<?php
			$query = $mth->query("SELECT * FROM ".module_table." WHERE parent_id='0' ORDER BY title");
